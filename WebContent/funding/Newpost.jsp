...
<H1 style="text-align:center">修改提案</H1>
<div style="width:800px;margin-left:350px">
<form method="POST" action="<c:url value='UpdatePostno' />"
	  id="UpdatePostno" >
<div style="background-color:#98E294;border-radius:20px;padding-left:20px;padding-top:30px">
<label>主題:</label>
<input type="text" name="postname" value="${PBean.postname}"  style="width: 180px;" id="postname">
<span id="msgPostName"></span>
<br><br>

<label>提案人:</label>
<input type="text" name="name" value="${PBean.name}"  style="width: 180px;" id="name">
<span id="msgName"></span>
<br><br>

<label>專案金額:</label>
<input type="text" name="amount" value="${PBean.amount}"  style="width: 180px;" id="amount">
<span id="msgAmount"></span>
<br><br>


<label>到期日:</label>
<input type="date" name="expdate" value="${PBean.expdate}"  style="width: 180px;" id="expdate">
...
<br><br>
<input type="hidden" name="postno" value="${PBean.postno}" >
<input style="font-size:25px;margin-left:350px" type="submit" value="送出">
<a href="<c:url value='GetAll2.do' />" style="color:red;margin-left:50px">取消</a>
</div>
