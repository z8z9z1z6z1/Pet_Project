...
<script type="text/javascript">
		...
		btn.onclick = function() {
			...
			xhr.onreadystatechange = function() {
				if (xhr.readyState == 4 && xhr.status == 200) {
					...
					var singleProduct = xhr.responseText;
					
					box.innerHTML="<h3>"+singleProduct+"<h3>";
				}
				}
			
			xhr.open("GET", "<c:url value='/test2' />", true);
			// 送出請求
			xhr.send();
		}
	...
	function showSingleProduct(data){
		var conunt=data.productBean;

		product.innterHTML=count;
		}	
</script>
...
<body>
	...
	<div align="center">
		<h2>選取您的號碼</h2>
		<input type="button" id='btn' name='id' value='1'>
		<div id='box'></div>
				...
				<div class="row">
					<div class="col-md-4 text-center animate-box">
						<div class="product">
							...
							<div class="desc">
								<h3>
									<a href="single.html">The WW Chair</a>
								</h3>
					...
					<div class="col-md-4 text-center animate-box">
						<div class="product">
							<div class="product-grid"
								style="background-image: url(images/product-8.jpg);">
								<div class="inner">
									<p>
										<a href="single.html" class="icon"><i
											class="icon-shopping-cart"></i></a> <a href="single.html"
							...
							<div class="desc">
								<h3>
									<a href="single.html">Himitsu Money Box</a>
								</h3>
					...
					<div class="col-md-4 text-center animate-box">
						<div class="product">
							<div class="product-grid"
								style="background-image: url(images/product-9.jpg);">
								<div class="inner">
									<p>
										<a href="single.html" class="icon"><i
											class="icon-shopping-cart"></i></a> <a href="single.html"
							...
							<div class="desc">
								<h3>
									<a href="single.html">Ariane Prin</a>
								</h3>
